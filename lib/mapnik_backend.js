...
MapnikSource.prototype._normalizeURI = function(uri) {
    ...
    if (!uri.query.srs) {
        uri.query.srs = "+proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0.0 +k=1.0 +units=m +nadgrids=@null +wktext +no_defs +over";
        uri.query.minx = -6378137*Math.PI;
        uri.query.miny = -6378137*Math.PI;
        uri.query.maxx = 6378137*Math.PI;
        uri.query.maxy = 6378137*Math.PI;
    } else {
