...
function getImage(source, image, options, x, y, callback) {
    ...
    view.isSolid(function(err, solid, pixel) {
        ...
        // BEGIN TEMP
        // explicitly disable solid cache until a new version of mapnik is
        // out that has this issue fixed (should be soon):
        // https://github.com/mapnik/node-mapnik/issues/433
        solid = false;
